...
export const NODE_DEFAULT_SIZE = {
    ...
    [CanvasNodeType.Config]: { width: 380, height: 320, title: "生成配置" },
    [CanvasNodeType.Video]: { width: 420, height: 236, title: "Video" },
    [CanvasNodeType.Audio]: { width: 340, height: 120, title: "Audio" },
} satisfies Record<CanvasNodeType, { width: number; height: number; title: string }>;

export const NODE_MIN_SIZE: Record<CanvasNodeType, { minWidth: number; minHeight: number }> = {
    [CanvasNodeType.Image]: { minWidth: 220, minHeight: 160 },
    [CanvasNodeType.Text]: { minWidth: 220, minHeight: 160 },
    [CanvasNodeType.Config]: { minWidth: 380, minHeight: 320 },
    [CanvasNodeType.Video]: { minWidth: 320, minHeight: 180 },
    [CanvasNodeType.Audio]: { minWidth: 280, minHeight: 100 },
};
