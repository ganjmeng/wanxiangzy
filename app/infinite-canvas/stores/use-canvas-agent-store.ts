...
import { INFINITE_CANVAS_LOCAL_AGENT_URL } from "@/lib/infinite-canvas-public-env";
...
export const useCanvasAgentStore = create<CanvasAgentStore>((set) => ({
    ...
    url: typeof window === "undefined" ? INFINITE_CANVAS_LOCAL_AGENT_URL : localStorage.getItem("canvas-agent-url") || INFINITE_CANVAS_LOCAL_AGENT_URL,
