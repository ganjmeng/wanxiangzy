...
function imageModels(): AiLogicalModel[] {
  return [
    ...
    imageModel("qwen3", "Qwen3 Image", ["generation", "edit"], { "1K": 3, "2K": 5 }, "千问3", "NEW", "qwen.png", 40),
    imageModel("qwen3-pro", "Qwen3 Image Pro", ["generation", "edit"], { "1K": 5, "2K": 7 }, "千问3 Pro", "PRO", "qwen.png", 50),
    imageModel("z-image", "Z-Image", ["generation"], { "1K": 3 }, "Z-Image", "NEW", "z-image.png", 60),
  ];
}
