...
const OPTIONAL_ENV: EnvContractEntry[] = [
  ...
  { name: "KIE_BANANA_API_KEY", category: "optional", description: "Kie Market key for Nano Banana 2, Pro, and Lite; seeded encrypted into the control plane." },
  { name: "KIE_GPT_IMAGE_API_KEY", category: "optional", description: "Kie Market key for GPT Image 2; seeded encrypted into the control plane." },
  { name: "KIE_QWEN_API_KEY", category: "optional", description: "Kie Market key for Qwen3, Qwen3 Pro, and Z-Image; seeded encrypted into the control plane." },
  { name: "KIE_VIDEO_API_KEY", category: "optional", description: "Kie Market key for MiniMax H3, Seedance, and Wan video models; seeded encrypted into the control plane." },
  { name: "KIE_MARKET_POLL_INTERVAL_MS", category: "optional", description: "Kie asynchronous task polling interval, default 5000ms." },
  { name: "KIE_MARKET_TASK_TIMEOUT_MS", category: "optional", description: "Kie asynchronous task polling window, default 20 minutes." },
